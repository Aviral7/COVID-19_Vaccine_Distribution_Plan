...
file = '/Users/aviralmehrotra/Downloads/Code/MTF/2020-2021/Vaccination Simulation/Grid/codingTable.csv'
...
while remainingPopulation > 0.5 and remainingPopulation != duplicate:
    duplicate = remainingPopulation
